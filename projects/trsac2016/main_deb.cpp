...
float objectMixVal = 0;
float camRadiusVal = 0;
...
*/
	...
	RES_X = setup->scrWidth;
	RES_Y = setup->scrHeight;
...
void RenderAudioToFile()
{
	...
	sprintf(pathAudio, "%s\\%s", path, "music.wav");
...
int WINAPI WinMain( HINSTANCE instance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow )
{
	...
	if (_getcwd(cwd, sizeof(cwd)) != NULL)
		MessageBox(0, cwd, "CWD", MB_OK | MB_ICONINFORMATION);
	return 0;
	*/
	paused = false;
