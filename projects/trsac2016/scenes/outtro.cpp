...
effect_outro::effect_outro(UINT32 texNoise, UINT32 texColor, UINT32 texNoise3d, UINT32 texNoise3dFix)
{
...
void effect_outro::draw_effect(float itime)
{
#ifdef DEBUG
	shaderMain->refresh();
#endif
...
void effect_outro::draw(float itime)
{
	glEnable(GL_DEPTH_TEST);
