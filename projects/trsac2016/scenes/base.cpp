...
effect_base::effect_base(UINT32 texNoise, UINT32 texColor, UINT32 texNoise3d, UINT32 texNoise3dFix)
{
...
void effect_base::draw_effect(float itime)
{
#ifdef DEBUG
	shaderMain->refresh();
#endif
...
void effect_base::draw(float itime)
{
	glEnable(GL_DEPTH_TEST);
