#include "ice_tunnel.h"

ice_tunnel::ice_tunnel(UINT32 texNoise, UINT32 texColor, UINT32 texNoise3d, UINT32 texNoise3dFix)
{
	...
	shaderMain = new shader(
		"shaders\\include\\tunnel.vert",
		NULL,
		"shaders\\include\\tunnel.frag",
		"",
		"water"
		);
#else
...
#ifdef DEBUG
void ice_tunnel::reload()
{
	shaderMain->reload();
}
#endif

void ice_tunnel::draw_effect(float itime)
{
#ifdef DEBUG
	shaderMain->refresh();
#endif
...
void ice_tunnel::draw(float itime)
{
	glEnable(GL_DEPTH_TEST);
