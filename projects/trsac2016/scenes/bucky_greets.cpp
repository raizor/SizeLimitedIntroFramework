#include "bucky_greets.h"

effect_greets::effect_greets(UINT32 texNoise, UINT32 texColor, UINT32 texNoise3d, UINT32 texNoise3dFix)
{
...
void effect_greets::draw_effect(float itime)
{
#ifdef DEBUG
	shaderMain->refresh();
#endif
...
void effect_greets::draw(float itime)
{
	glEnable(GL_DEPTH_TEST);
